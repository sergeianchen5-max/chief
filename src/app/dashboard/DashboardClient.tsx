...
export default function DashboardClient({ user, profile, initialRecipes }: DashboardClientProps) {
    const [savedRecipes, setSavedRecipes] = useState<SavedRecipeRow[]>(initialRecipes);
