...
import { Plus, Trash2, Camera, Loader2, Apple, Milk, Beef, Wheat, Snowflake, Package, X, ChevronDown, Check } from 'lucide-react';
import { recognizeIngredients } from '../services/geminiService';
